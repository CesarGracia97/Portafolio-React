...
const Experiences = () => {
  ...
  <div id="experiences" className="container experiences-container">
    ...
    <div className="experience experience-4">
      <div className="experience-img"></div>
      <div className="experience-info">
        <h1 className="name">Articulos de Oficina</h1>
